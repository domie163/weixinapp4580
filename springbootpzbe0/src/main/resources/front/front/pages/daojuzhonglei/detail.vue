...
<script>
	export default {
		...
		methods: {
			// 支付
			onPayTap(){
				uni.setStorageSync('paytable','daojuzhonglei');
			...
			onAcrossTap(tableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
				uni.setStorageSync('crossTable','daojuzhonglei');
			...
			async init(){
				...
				let res = await this.$api.info('daojuzhonglei', this.id);
			...
			// 添加评论
			async onCommentTap() {
				this.$utils.jump(`../discussdaojuzhonglei/add-or-update?refid=${this.id}`)
			},
			onSHTap() {
